...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		if (tokens .size() > 1){
			...
			if(!hasPunctuation(lastChar)){
				numSentences++;
			}		
		}
	}

	//** Help function for process text 	
	public boolean hasPunctuation(char singleChar){
...
//        EfficientDocument testDoc = new EfficientDocument("test hello");
//        testDoc.getWordList();
